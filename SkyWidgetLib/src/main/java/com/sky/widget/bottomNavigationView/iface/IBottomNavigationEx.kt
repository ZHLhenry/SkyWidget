...
/**
 * BottomNavigationView 扩展接口
 *
 * 定义了 BottomNavigationView 的所有增强功能接口，
 * 包括图标/文字控制、样式设置、ViewPager 联动、动态菜单配置等。
 *
 * @param BNV BottomNavigationView 类型
 * @param BNMV BottomNavigationMenuView 类型
 * @param BNIV BottomNavigationItemView 类型
 */
